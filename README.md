...
<body class="text-slate-200 min-h-screen antialiased custom-scroll">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <!-- TARJETAS DE INDICADORES GLOBALES (CONTEOS EN NÚMEROS ENTEROS REALES) -->
            ...
            <div class="premium-card rounded-2xl p-6 shadow-xl">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 border-b border-slate-800/80 pb-4">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Lista completa consolidada de la sección de morosidad</p>
                    </div>
                    <div>
    ...
    <script>
        ...
        async function loadAllDashboardData() {
            try {
                ...
                let totalMat = 0, totalPag = 0, totalDes = 0, totalCum = 85;

                // ==========================================
                // ESCÁNER DINÁMICO DE COLUMNAS ASOCIATIVAS
                // ==========================================
                ...
                for (let i = 0; i < Math.min(rows.length, 10); i++) {
                    ...
                    if (dIdx !== -1 && dIdx > 12) {
                        ...
                        colMoroTutor = labels.indexOf('TUTOR') !== -1 ? labels.indexOf('TUTOR') : dIdx + 3;
                ...
                // Cargar cabeceras del cronograma real dinámicamente
                let cuotasHeaderRow = rows.find(r => r && r.c && safeString(r.c[colCuota]).toUpperCase() === 'CUOTA');
                if (cuotasHeaderRow) {
                ...
                for (let i = 0; i < rows.length; i++) {
                    ...
                    // --- 1. PROCESAR ANALISIS DESERCION DESDE LESLY ---
                    ...
                    if (desDataStarted) {
                        if (cicloVal.toUpperCase().includes('TOTAL')) {
                            ...
                            totalCum = totalMat > 0 ? (totalPag / totalMat) * 100 : 85; // Cálculo automático dinámico exacto
                    ...
                    // --- 2. PROCESAR CRONOGRAMA DE CUOTAS ---
                    ...
                    // --- 3. PROCESAR MOROSIDAD COMPLETA (Y3:AE1000) ---
                ...
                // Renderizar KPI Globales reales (85%)
